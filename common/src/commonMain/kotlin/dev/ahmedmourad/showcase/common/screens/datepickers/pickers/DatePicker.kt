...
import dev.ahmedmourad.showcase.common.screens.datepickers.components.QuickSelectorsBar
import dev.ahmedmourad.showcase.common.screens.datepickers.components.YearsView
import dev.ahmedmourad.showcase.common.utils.getDisplayName
import dev.ahmedmourad.showcase.common.utils.lambdaOrNull
...
fun CurrentPickerView(
    ...
    ConsiderateBox(modifier) {
        dev.ahmedmourad.showcase.common.screens.datepickers.components.DaysView(
            selected = selected,
            onSelectedChange = onSelectedChange,
            state = state,
